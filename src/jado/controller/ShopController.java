...
public class ShopController {
	...
	@RequestMapping(value = "/setting/api/theme", method = RequestMethod.POST)
...
//		shopUrl정보의 banner_url을 수정 한다.
	...
	@RequestMapping(value = "/setting/api/bannerUrl", method = RequestMethod.POST)
...
//		shopUrl정보의 banner_url을 수정 한다.
	...
	@RequestMapping(value = "/setting/api/mainUrl", method = RequestMethod.POST)
	public String editMain(Model model,HttpSession session) throws ServletException, IOException {
//		image 파일과, shop url을 받는다.
//		
		return "blogDummy";
	}
	@RequestMapping(value = "/setting/api/logoUrl", method = RequestMethod.POST)
