...
CREATE TABLE IF NOT EXISTS `jado_dev`.`SHOP` (
  ...
  `PHONE` VARCHAR(45) NOT NULL,
  `BANNER_URL` VARCHAR(256) NOT NULL DEFAULT '/userImg/shop/banner/default.png',
  `MAIN_URL` VARCHAR(256) NOT NULL DEFAULT '/userImg/shop/main/default.png',
  `LOGO_URL` VARCHAR(256) NOT NULL DEFAULT '/userImg/shop/logo/default.png',
